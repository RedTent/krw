...
De toetsing voor de macrofytensoortensamenstelling is zeer vergelijkbaar met de macrofaunatoetsing. Het is mogelijk om meerdere monsters tegelijk te toetsen met de functie `dplyr::group_by`. 

Voor macrofyten moet vaak eerst de bedekking omgerekend worden naar een abundantieklassen. Voor de macrofyten gebeurt dit met een aparte functie. Deze functie rekent zowel percentages (`type = "percentage"`) als klassen (1 t/m 9 `type = "klasse"`) om.
